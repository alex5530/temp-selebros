...
/**
 * Provides necessary meta information about the celebros hmc extension.
 * 
 * 
 * @version ExtGen v5.5.0.0-M3
 */
public class CelebrosHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(CelebrosHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.celebros.hmc.locales";
