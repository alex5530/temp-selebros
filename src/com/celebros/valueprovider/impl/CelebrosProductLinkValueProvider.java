...
/**
 * Celebros value provider for product link attribute
 */
public class CelebrosProductLinkValueProvider implements FieldValueProvider
{
	...
	{
		return Collections.singleton(new FieldValue("", celebrosExportService.getProductUrl((ProductModel) obj)));
	}
